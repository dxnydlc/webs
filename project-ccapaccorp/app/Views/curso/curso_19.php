...
$Titulo_curso_inferior = 'CONTABILIDAD PARA NO CONTADORES';
$Titulo_curso_superior = 'CONTABILIDAD PARA NO CONTADORES';


# Expositor
$Expositor_alias        = 'Expositor';// Expositor | Expositora
$Expositor              = 'CPC DENIS ZAVALETA AMPUERO';
$Exposito_Thumb         = '/2024/11-11/Denis-Zavaleta-Ampuero.jpg';
$imagen_expositor_interno = '/2024/11-11/Denis-Zavaleta-Ampuero.jpg';
$acerca_instrucctor = '
Contador Público Colegiado, con estudios de especialización en Finanzas y Tributación en la universidad ESAN.
<br/>
Es asesor contable, tributario y financiero de diversas empresas del sector privado. Asimismo, es contador general de empresa del rubro industrial. Del mismo modo, se desempeñó como asesor contable y tributario en Thomson Reuters Perú (ex estudio Caballero Bustamante), por último, ha sido auditor contable y tributario de SUNAT. 
';

# Texto de WhatsApp
# https://www.urlencoder.org/
# Hola quiero inscribirme al seminario: ccccc
$texto_whatsApp = 'https://wa.me/51941280252?text=Hola%20quiero%20inscribirme%20al%20seminario%3A%20Contabilidad%20para%20no%20contadores';
...
<p class="course-details__overview__text" style="font-size:20px;" >
    <strong>CONTABILIDAD PARA NO CONTADORES:</strong>
</p>
<p class="course-details__overview__text" style="font-size:20px;margin-bottom: 3px;" >
Este curso te permitirá conocer y entender los conceptos básicos de la contabilidad, la dinámica contable y las principales operaciones contables. Asimismo, podrás analizar e interpretar los estados financieros y los aspectos tributarios más importantes de forma práctica.

<br/><br/>
<strong>Dirigido a:</strong>
Emprendedores, empresarios, profesionales de diversas especialidades y todas aquellas personas que deseen adquirir conocimientos básicos en contabilidad sin contar con experiencia previa en la materia. 
<br/><br/>
Temas a tratar:
...
<ul class="list-unstyled course-details__overview__lists">
    ...
    <li>
        <span class="icon-check"></span>
        Principales normas contables (Nic, NIIF)
    <li>
    <li>
        <span class="icon-check"></span>
        Estados Financieros
...
<ul class="list-unstyled course-details__overview__lists">
    ...
    <li>
        <span class="icon-check"></span>
        Regímenes tributarios y sus obligaciones
    <li>
    <li>
        <span class="icon-check"></span>
        Libros contables y Registros vinculados asuntos tributarios
    <li>
    <li>
        <span class="icon-check"></span>
        Liquidación de Impuestos IGV y Renta, Declaración mensual y anual
    <li>
    <li>
        <span class="icon-check"></span>
        Casos prácticos
...
<ul class="list-unstyled course-details__overview__lists">
    ...
    <li>
        <span class="icon-check"></span>
        Durante el seminario tendrás la oportunidad de interactuar directamente con el especialista en la materia.
    <li>
</ul>
