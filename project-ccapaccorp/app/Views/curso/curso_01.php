...
<section class="page-header page-header--bg-two"  >
    ...
    <div class="container text-center">
        <h2 class="page-header__title">¿Sabes cómo afrontar exitosamente una inspección de SUNAFIL? </h2><!-- /.page-title -->
                ...
                <div class="row">
                    <div class="col-xl-12 ">
                        <div class="course-details__thumb">
                            <img src="/2024/curso-banner-01.jpeg" alt="eduact" />
                        </div><!-- details-thumb -->
                        <div class="course-details__meta">
                            ...
                            <div class="course-details__meta__cats"><a href="course.html">Seminario on-line</a></div>
