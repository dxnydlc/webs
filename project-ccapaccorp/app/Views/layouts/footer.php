        ...
        <footer class="main-footer-two">
            <div class="main-footer-two__bg" style="background-image: url(<?= esc($APP_URL) ?>assets/images/shapes/footer-bg-2.png);"></div>
            <div class="container">
                <div class="row">
                    <div class="col-xl-4 col-md-5 wow fadeInUp" data-wow-delay="100ms">
                        <div class="main-footer-two__about">
                            <a href="index.html" class="main-footer-two__logo">
                                <img src="<?= esc($APP_URL) ?>assets/images/footer-logo-two.png" alt="eduact" width="159" height="40">
                            </a><!-- /.footer-logo -->
                    ...
                    <div class="col-xl-3 col-md-12 wow fadeInUp" data-wow-delay="400ms">
                        <div class="main-footer-two__gallery">
                            ...
                            <div class="main-footer-two__galleries">
                                <a class="img-popup" href="<?= esc($APP_URL) ?>assets/images/gallery/fg-1.jpg"><img src="<?= esc($APP_URL) ?>assets/images/gallery/fg-1.jpg" alt="eduact"></a>
                                <a class="img-popup" href="<?= esc($APP_URL) ?>assets/images/gallery/fg-2.jpg"><img src="<?= esc($APP_URL) ?>assets/images/gallery/fg-2.jpg" alt="eduact"></a>
                                <a class="img-popup" href="<?= esc($APP_URL) ?>assets/images/gallery/fg-3.jpg"><img src="<?= esc($APP_URL) ?>assets/images/gallery/fg-3.jpg" alt="eduact"></a>
                                <a class="img-popup" href="<?= esc($APP_URL) ?>assets/images/gallery/fg-4.jpg"><img src="<?= esc($APP_URL) ?>assets/images/gallery/fg-4.jpg" alt="eduact"></a>
                                <a class="img-popup" href="<?= esc($APP_URL) ?>assets/images/gallery/fg-5.jpg"><img src="<?= esc($APP_URL) ?>assets/images/gallery/fg-5.jpg" alt="eduact"></a>
                                <a class="img-popup" href="<?= esc($APP_URL) ?>assets/images/gallery/fg-6.jpg"><img src="<?= esc($APP_URL) ?>assets/images/gallery/fg-6.jpg" alt="eduact"></a>
                            </div>
                        </div><!-- /.gallery -->
                    </div>
                </div><!-- /.row -->
