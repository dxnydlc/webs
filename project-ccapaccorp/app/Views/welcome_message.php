...
<!-- ============================================================== -->
		...
		"margin": 0
                ...
                <div class="item"><!-- slider-item-start -->
                    <div class="main-slider__item">
                        <div class="main-slider__bg" style="background-image: url(<?= esc($APP_URL) ?>assets/images/shapes/slider-bg-1.jpg);"></div><!-- slider-image-->
                        <div class="main-slider__shape-one"><img src="<?= esc($APP_URL) ?>assets/images/shapes/slider-shape-1.png" alt="eduact" /></div><!-- slider-shape-1 -->
                        <div class="main-slider__shape-two"><img src="<?= esc($APP_URL) ?>assets/images/shapes/slider-shape-2.png" alt="eduact" /></div><!-- slider-shape-2 -->
                        <div class="container">
                            <div class="row">
                                <div class="col-lg-6">
                                ...
                                <div class="col-lg-6">
                                    <div class="main-slider__layer">
                                        <div class="main-slider__layer-thumb eduact-tilt" data-tilt-options='{ "glare": false, "maxGlare": 0, "maxTilt": 2, "speed": 700, "scale": 1 }'>
                                            <img src="<?= esc($APP_URL) ?>assets/images/resources/slider-layer.png" alt="eduact">
                                        </div>
                                    ...
                                    <div class="main-slider__shape-six">
                                        <img src="<?= esc($APP_URL) ?>assets/images/shapes/slider-shape-6.png" alt="eduact" />
                                    </div><!-- slider-shape-6 -->
                                    <div class="main-slider__shape-seven">
                                        <img src="<?= esc($APP_URL) ?>assets/images/shapes/slider-shape-7.png" alt="eduact" />
                                    </div><!-- slider-shape-6 -->
                                    <div class="main-slider__shape-eight">
                                        <span class="icon-business"></span>
                                    </div><!-- slider-shape-6 -->
                                    <div class="main-slider__shape-nine">
                                        <img src="<?= esc($APP_URL) ?>assets/images/shapes/slider-shape-9.png" alt="eduact" />
                                    </div><!-- slider-shape-6 -->
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-xl-6 wow fadeInLeft" data-wow-delay="100ms">
                        <div class="about-three__content"><!-- about content start-->
                            ...
                            <div class="about-three__box">
                                ...
                                <h4 class="about-three__box__title">Flexible Classes</h4>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="about-three__author">
                                        <div class="about-three__author__thumb"><img src="<?= esc($APP_URL) ?>assets/images/resources/about-author.jpg" alt="eduact"></div>
                                        <img src="<?= esc($APP_URL) ?>assets/images/resources/about-sign.png" alt="eduact">
                                        <p class="about-three__author__text">Jone Martin, CEO </p>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="about-three__info">
                                        ...
                                        <h4 class="about-three__info__title"><a href="tel:6845550102">+(684) 555-0102</a></h4>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="col-xl-6 wow fadeInRight" data-wow-delay="100ms">
                        <div class="about-three__thumb"><!-- about thumb start -->
                            <div class="about-three__thumb__one eduact-tilt" data-tilt-options='{ "glare": false, "maxGlare": 0, "maxTilt": 2, "speed": 700, "scale": 1 }'>
                                <img src="<?= esc($APP_URL) ?>assets/images/resources/about-3-1.jpg" alt="eduact">
                            </div><!-- /.about-thumb-one -->
                            ...
                            <div class="about-three__thumb__shape-four"><img src="<?= esc($APP_URL) ?>assets/images/shapes/about-3-shape-1.png" alt="eduact" /></div><!-- /.about-shape-four -->
        ...
        <!-- About End -->
        <!-- Service Start -->
        <section class="service-three" style="background-image: url(<?= esc($APP_URL) ?>assets/images/shapes/service-bg-3.png);">
            <div class="container">
                <div class="row">
                    <div class="col-lg-6">
                ...
                <div class="row">
                    <div class="col-xl-3 col-md-6 wow fadeInUp" data-wow-delay="200ms">
                        <div class="service-three__item text-center">
                            <div class="service-three__wrapper">
                                <div class="service-three__hover" style="background-image: url(<?= esc($APP_URL) ?>assets/images/service/1.jpg);"></div><!-- /.service-icon -->
                                ...
                                <p class="service-three__text">Lorem ipsum dolor sit amet consectetur. Convallis ornare semper id hendrerit</p><!-- /.service-content -->
                                <div class="service-three__br"></div>
                                <a class="service-three__rm" href="team.html"></a>
                            </div>
                    ...
                    <div class="col-xl-3 col-md-6 wow fadeInUp" data-wow-delay="300ms">
                        <div class="service-three__item text-center">
                            <div class="service-three__wrapper">
                                <div class="service-three__hover" style="background-image: url(<?= esc($APP_URL) ?>assets/images/service/2.jpg);"></div><!-- /.service-icon -->
                                <div class="service-three__icon">
                                    <span class="icon-business"></span>
                                </div><!-- /.service-icon -->
                                <h3 class="service-three__title">
                                ...
                                <p class="service-three__text">Lorem ipsum dolor sit amet consectetur. Convallis ornare semper id hendrerit</p><!-- /.service-content -->
                                <div class="service-three__br"></div>
                                <a class="service-three__rm" href="team-become.html"></a>
                            </div>
                        </div><!-- /.service-card-three -->
                    </div>
                    <div class="col-xl-3 col-md-6 wow fadeInUp" data-wow-delay="400ms">
                        <div class="service-three__item text-center">
                            <div class="service-three__wrapper">
                                <div class="service-three__hover" style="background-image: url(<?= esc($APP_URL) ?>assets/images/service/3.jpg);"></div><!-- /.service-icon -->
                                <div class="service-three__icon">
                                ...
                                <p class="service-three__text">Lorem ipsum dolor sit amet consectetur. Convallis ornare semper id hendrerit</p><!-- /.service-content -->
                                <div class="service-three__br"></div>
                                <a class="service-three__rm" href="course.html"></a>
                            </div>
                        </div><!-- /.service-card-three -->
                    </div>
                    <div class="col-xl-3 col-md-6 wow fadeInUp" data-wow-delay="500ms">
                        <div class="service-three__item text-center">
                            <div class="service-three__wrapper">
                                <div class="service-three__hover" style="background-image: url(<?= esc($APP_URL) ?>assets/images/service/4.jpg);"></div><!-- /.service-icon -->
                                <div class="service-three__icon">
                                ...
                                <p class="service-three__text">Lorem ipsum dolor sit amet consectetur. Convallis ornare semper id hendrerit</p><!-- /.service-content -->
                                <div class="service-three__br"></div>
                                <a class="service-three__rm" href="about.html"></a>
                            </div>
                        </div><!-- /.service-card-three -->
                    </div>
                </div>
        ...
        <!-- Service End -->
        <!-- Video Start -->
        <section class="video-two" data-jarallax data-speed="0.3" data-imgPosition="50% -100%">
            <div class="video-two__bg jarallax-img" style="background-image: url(<?= esc($APP_URL) ?>assets/images/backgrounds/video-bg-2.jpg);"></div>
            <div class="video-two__shape" style="background-image: url(<?= esc($APP_URL) ?>assets/images/shapes/video-shape-3.png);"></div>
            <div class="container">
                <div class="row d-flex align-items-center">
                    <div class="col-xl-6 col-md-7 wow fadeInLeft" data-wow-delay="200ms">
                        <h3 class="video-two__title">Discover the Campus Through<br> a Video Tour</h3>
                    ...
                    <div class="col-xl-6 col-md-5 wow fadeInRight" data-wow-delay="200ms">
        ...
        <!-- Video End -->
        <!-- Counter Start -->
        <section class="fact-two" style="background-image: url(<?= esc($APP_URL) ?>assets/images/shapes/fact-bg-2.png);">
            <div class="container">
                <div class="fact-two__inner" style="background-image: url(<?= esc($APP_URL) ?>assets/images/shapes/fact-bg-inner.png);">
                    <div class="row">
                        <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="100ms">
                            <div class="fact-two__item text-center">
                                <div class="fact-two__icon"><span class="icon-Headphone-Women"></span></div>
                                <div class="fact-two__count">
                                    <span class="count-box">
                                        <span class="count-text" data-stop="30.3" data-speed="1500"></span>
                                    </span>k
                                </div><!-- /.fact-two__count -->
                                <h3 class="fact-two__title">Student Enrolled</h3><!-- /.fact-two__title -->
                            </div><!-- /.fact-item -->
                        </div>
                        <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="200ms">
                            <div class="fact-two__item fact-two__item--smnone text-center">
                                <div class="fact-two__icon"><span class="icon-Online-learning"></span></div>
                                <div class="fact-two__count">
                                    <span class="count-box">
                                        <span class="count-text" data-stop="40.5" data-speed="1500"></span>
                                    </span>k
                                </div><!-- /.fact-two__count -->
                                <h3 class="fact-two__title">Class completed</h3><!-- /.fact-two__title -->
                            </div><!-- /.fact-item -->
                        </div>
                        <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="300ms">
                            <div class="fact-two__item text-center">
                                <div class="fact-two__icon"><span class="icon-ratings"></span></div>
                                <div class="fact-two__count">
                                    <span class="count-box">
                                        <span class="count-text" data-stop="88.9" data-speed="1500"></span>
                                    </span>%
                                </div><!-- /.fact-two__count -->
                                <h3 class="fact-two__title">satisfaction rate</h3><!-- /.fact-two__title -->
                            </div><!-- /.fact-item -->
                        </div>
                        <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="400ms">
                            <div class="fact-two__item fact-two__item--noborder text-center">
                                <div class="fact-two__icon"><span class="icon-instructor"></span></div>
                                <div class="fact-two__count">
                                    <span class="count-box">
                                        <span class="count-text" data-stop="6.30" data-speed="1500"></span>
                                    </span>+
                                </div><!-- /.fact-two__count -->
                                <h3 class="fact-two__title">Top instructors</h3><!-- /.fact-two__title -->
                            </div><!-- /.fact-item -->
                        </div>
                    </div>
                </div>
        ...
        <!-- Counter End -->
        <!-- Course Start -->
        <section class="course-three" style="background-image: url(<?= esc($APP_URL) ?>assets/images/shapes/course-bg-3.png);">
            <div class="container">
                ...
                <div class="row">
                    <div class="col-xl-6 wow fadeInUp" data-wow-delay="200ms">
                        <div class="course-three__item">
                            <div class="course-three__thumb">
                                <img src="<?= esc($APP_URL) ?>assets/images/course/course-3-1.png" alt="eduact">
                            </div><!-- /.course-thumb -->
                            <div class="course-three__content">
                                ...
                                <div class="course-three__bottom">
                                    <div class="course-three__author">
                                        <img src="<?= esc($APP_URL) ?>assets/images/course/author-1.png" alt="eduact">
                                    ...
                                    <div class="course-three__meta">
                                        <h4 class="course-three__meta__price">$473.00</h4>
                    ...
                    <div class="col-xl-6 wow fadeInUp" data-wow-delay="300ms">
                        <div class="course-three__item">
                            <div class="course-three__thumb">
                                <img src="<?= esc($APP_URL) ?>assets/images/course/course-3-2.png" alt="eduact">
                            </div><!-- /.course-thumb -->
                            <div class="course-three__content">
                                ...
                                <div class="course-three__bottom">
                                    <div class="course-three__author">
                                        <img src="<?= esc($APP_URL) ?>assets/images/course/author-3.png" alt="eduact">
                                        <h5 class="course-three__author__name">Guy Hawkins</h5>
                                        <p class="course-three__author__designation">Project Manager</p>
                                    </div>
                                    <div class="course-three__meta">
                    ...
                    <div class="col-xl-6 wow fadeInUp" data-wow-delay="400ms">
                        <div class="course-three__item">
                            <div class="course-three__thumb">
                                <img src="<?= esc($APP_URL) ?>assets/images/course/course-3-3.png" alt="eduact">
                            </div><!-- /.course-thumb -->
                            <div class="course-three__content">
                                <div class="course-three__time">30 Hours</div>
                                <div class="course-three__ratings">
                                    <span class="icon-star"></span><span class="icon-star"></span><span class="icon-star"></span><span class="icon-star"></span><span class="icon-star"></span>
                                    <div class="course-three__ratings__reviews">(30 Reviews)</div>
                                </div>
                                ...
                                <div class="course-three__bottom">
                                    <div class="course-three__author">
                                        <img src="<?= esc($APP_URL) ?>assets/images/course/author-2.png" alt="eduact">
                                        <h5 class="course-three__author__name">Guy Hawkins</h5>
                                        <p class="course-three__author__designation">Project Manager</p>
                                    </div>
                                    <div class="course-three__meta">
                                        <h4 class="course-three__meta__price">$360.00</h4>
                                        <p class="course-three__meta__class">15 Lessons</p>
                                    </div>
                                </div>
                            </div><!-- /.course-content -->
                    ...
                    <div class="col-xl-6 wow fadeInUp" data-wow-delay="500ms">
                        <div class="course-three__item">
                            <div class="course-three__thumb">
                                <img src="<?= esc($APP_URL) ?>assets/images/course/course-3-4.png" alt="eduact">
                            </div><!-- /.course-thumb -->
                            <div class="course-three__content">
                                <div class="course-three__time">36 Hours</div>
                                <div class="course-three__ratings">
                                    <span class="icon-star"></span><span class="icon-star"></span><span class="icon-star"></span><span class="icon-star"></span><span class="icon-star"></span>
                                    <div class="course-three__ratings__reviews">(50 Reviews)</div>
                                </div>
                                <h3 class="course-three__title">
                                ...
                                <div class="course-three__bottom">
                                    <div class="course-three__author">
                                        <img src="<?= esc($APP_URL) ?>assets/images/course/author-5.png" alt="eduact">
                                        <h5 class="course-three__author__name">Guy Hawkins</h5>
                                        <p class="course-three__author__designation">Project Manager</p>
                                    </div>
                                    <div class="course-three__meta">
                                        <h4 class="course-three__meta__price">$956.00</h4>
                                        <p class="course-three__meta__class">15 Lessons</p>
                                    </div>
                                </div>
                            </div><!-- /.course-content -->
        ...
        <!-- Course End -->
        <!-- Category Start -->
        <section class="category-three" style="background-image: url(<?= esc($APP_URL) ?>assets/images/shapes/category-bg-3.jpg);">
                ...
                <div class="row">
                    <div class="col-lg-3 col-md-6">
                        <div class="category-three__item category-three__item-two">
                            <div class="category-three__thumb"><img src="<?= esc($APP_URL) ?>assets/images/category/category-3-1.png" alt="eduact" /></div><!-- /.category-thumb -->
                            <div class="category-three__icon">
                                <span class="icon-portfolio"></span>
                            </div><!-- /.category-icon -->
                            <h3 class="category-three__title"><a href="about.html">Business Management</a></h3><!-- /.category-title -->
                        </div><!-- /.category-card-one -->
                    </div>
                    <div class="col-lg-3 col-md-6">
                        <div class="category-three__item">
                            <div class="category-three__thumb"><img src="<?= esc($APP_URL) ?>assets/images/category/category-3-2.png" alt="eduact" /></div><!-- /.category-thumb -->
                            <div class="category-three__icon">
                                <span class="icon-computer-science"></span>
                            </div><!-- /.category-icon -->
                            <h3 class="category-three__title"><a href="about.html">Computer Science</a></h3><!-- /.category-title -->
                        </div><!-- /.category-card-one -->
                    </div>
                    <div class="col-lg-3 col-md-6">
                        <div class="category-three__item">
                            <div class="category-three__thumb"><img src="<?= esc($APP_URL) ?>assets/images/category/category-3-3.png" alt="eduact" /></div><!-- /.category-thumb -->
                            <div class="category-three__icon">
                                <span class="icon-chart-up"></span>
                            </div><!-- /.category-icon -->
                            <h3 class="category-three__title"><a href="about.html">Personal Development</a></h3><!-- /.category-title -->
                        </div><!-- /.category-card-one -->
                    </div>
                    <div class="col-lg-3 col-md-6">
                        <div class="category-three__item category-three__item-four">
                            <div class="category-three__thumb"><img src="<?= esc($APP_URL) ?>assets/images/category/category-3-4.png" alt="eduact" /></div><!-- /.category-thumb -->
                            <div class="category-three__icon">
                                <span class="icon-art"></span>
                            </div><!-- /.category-icon -->
                            <h3 class="category-three__title"><a href="about.html">Arts and Design</a></h3><!-- /.category-title -->
                        </div><!-- /.category-card-one -->
                    </div>
                </div>
            </div>
        ...
        <section class="testimonial-three">
            <div class="container">
                ...
                "dots":false
                        ...
                        <a href="#item1" class="item" data-hash="item1"><img src="<?= esc($APP_URL) ?>assets/images/resources/testimonial-3-1.jpg" alt="eduact"></a><!-- Testimonial Item -->
                        <a href="#item2" class="item" data-hash="item2"><img src="<?= esc($APP_URL) ?>assets/images/resources/testimonial-3-2.jpg" alt="eduact"></a><!-- Testimonial Item -->
                        <a href="#item3" class="item" data-hash="item3"><img src="<?= esc($APP_URL) ?>assets/images/resources/testimonial-3-3.jpg" alt="eduact"></a><!-- Testimonial Item -->
                    </div>
                    <!-- Testimonial Thumb -->
                ...
                "navText": ["<span class=\"icon-arrow-left\"></span>","<span class=\"icon-arrow\"></span>"]
                        ...
                        <div class="item" data-hash="item1">
                            <div class="testimonial-three__item">
                                <div class="testimonial-three__author">
                                    <img src="<?= esc($APP_URL) ?>assets/images/resources/testimonial-3-1.jpg" alt="eduact">
                        ...
                        <div class="item" data-hash="item2">
                            <div class="testimonial-three__item">
                                <div class="testimonial-three__author">
                                    <img src="<?= esc($APP_URL) ?>assets/images/resources/testimonial-3-2.jpg" alt="eduact">
                                </div><!-- testimonial-author -->
                                <div class="testimonial-three__content">
                                    <div class="testimonial-three__quote">
                                        Flexible Classes refers to the process of acquiring knowledge or skills through the use
                        ...
                        <div class="item" data-hash="item3">
                            <div class="testimonial-three__item">
                                <div class="testimonial-three__author">
                                    <img src="<?= esc($APP_URL) ?>assets/images/resources/testimonial-3-3.jpg" alt="eduact">
                                </div><!-- testimonial-author -->
                                <div class="testimonial-three__content">
                                    <div class="testimonial-three__quote">
                                        Flexible Classes refers to the process of acquiring knowledge or skills through the use
        ...
        <!-- Testimonial End -->
        <!-- Team Start -->
        <section class="team-three" style="background-image: url(<?= esc($APP_URL) ?>assets/images/shapes/team-bg-3.png);">
            <div class="container">
                <div class="section-title text-center wow fadeInUp" data-wow-delay="100ms">
                    ...
                    <h2 class="section-title__title">Meet Our Professional<br> Instructor</h2>
                </div><!-- section-title -->
                <div class="row">
                    <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="200ms">
                        <div class="team-three__item">
                            <div class="team-three__image">
                                <img src="<?= esc($APP_URL) ?>assets/images/team/team-3-1.jpg" alt="eduact">
                            </div><!-- /.team-image -->
                    ...
                    <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="300ms">
                        <div class="team-three__item">
                            <div class="team-three__image">
                                <img src="<?= esc($APP_URL) ?>assets/images/team/team-3-2.jpg" alt="eduact">
                            </div><!-- /.team-image -->
                            <svg viewBox="0 0 314 318" xmlns="http://www.w3.org/2000/svg">
                                <path d="M0 128.442C0 127.672 0.466088 126.978 1.17922 126.687L309.669 0.767858C311.736 -0.076079 314 1.44482 314 3.67798V161C314 247.709 243.709 318 157 318C70.2913 318 0 247.709 0 161V128.442Z" />
                            </svg>
                    ...
                    <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="400ms">
                        <div class="team-three__item">
                            <div class="team-three__image">
                                <img src="<?= esc($APP_URL) ?>assets/images/team/team-3-3.jpg" alt="eduact">
                            </div><!-- /.team-image -->
                            <svg viewBox="0 0 314 318" xmlns="http://www.w3.org/2000/svg">
                                <path d="M0 128.442C0 127.672 0.466088 126.978 1.17922 126.687L309.669 0.767858C311.736 -0.076079 314 1.44482 314 3.67798V161C314 247.709 243.709 318 157 318C70.2913 318 0 247.709 0 161V128.442Z" />
                            </svg>
        ...
        <!-- Team End -->
        <!-- Blog Start -->
        <section class="blog-three" style="background-image: url(<?= esc($APP_URL) ?>assets/images/shapes/blog-bg-3.jpg);">
            <div class="container">
                <div class="section-title text-center wow fadeInUp" data-wow-delay="100ms">
                    <h5 class="section-title__tagline">
                        Latest Blog
                ...
                <div class="row">
                    <div class="col-xl-4 col-md-6 wow fadeInUp" data-wow-delay="200ms">
                        <div class="blog-three__item">
                            <div class="blog-three__image">
                                <img src="<?= esc($APP_URL) ?>assets/images/blog/blog-3-1.jpg" alt="eduact">
                                <a href="blog-details-right.html"></a>
                            </div><!-- /.blog-image -->
                            <div class="blog-three__content">
                                <div class="blog-three__top-meta">
                                    <div class="blog-three__cats"><a href="blog-list-right.html">Development</a></div><!-- /.blog-cats -->
                                    <div class="blog-three__date">26 Mar, 2023</div><!-- /.blog-date -->
                                </div>
                                ...
                                <div class="blog-three__meta">
                                    <div class="blog-three__meta__author">
                                        <img src="<?= esc($APP_URL) ?>assets/images/blog/author-1.png" alt="eduact" />
                                        <a href="blog-list-right.html">Darrell Steward</a>
                                        Fronted Developer
                                    </div>
                                    <a class="blog-three__rm" href="blog-details-right.html"><span class="icon-arrow"></span></a><!-- /.read-more-btn -->
                                </div><!-- /.blog-meta -->
                            </div><!-- /.blog-content -->
                        </div><!-- /.blog-card-one -->
                    </div>
                    <div class="col-xl-4 col-md-6 wow fadeInUp" data-wow-delay="300ms">
                        <div class="blog-three__item">
                            <div class="blog-three__image">
                                <img src="<?= esc($APP_URL) ?>assets/images/blog/blog-3-2.jpg" alt="eduact">
                                <a href="blog-details.html"></a>
                            </div><!-- /.blog-image -->
                            <div class="blog-three__content">
                                <div class="blog-three__top-meta">
                                    <div class="blog-three__cats"><a href="blog-list.html">Development</a></div><!-- /.blog-cats -->
                                    <div class="blog-three__date">26 Mar, 2023</div><!-- /.blog-date -->
                                </div>
                                <h3 class="blog-three__title">
                                ...
                                <div class="blog-three__meta">
                                    ...
                                    <a class="blog-three__rm" href="blog-details.html"><span class="icon-arrow"></span></a><!-- /.read-more-btn -->
                                </div><!-- /.blog-meta -->
                            </div><!-- /.blog-content -->
                        </div><!-- /.blog-card-one -->
                    </div>
                    <div class="col-xl-4 col-md-6 wow fadeInUp" data-wow-delay="400ms">
                        <div class="blog-three__item">
                            <div class="blog-three__image">
                                <img src="<?= esc($APP_URL) ?>assets/images/blog/blog-3-3.jpg" alt="eduact">
                                <a href="blog-details-left.html"></a>
                            </div><!-- /.blog-image -->
                            <div class="blog-three__content">
                                <div class="blog-three__top-meta">
                                    <div class="blog-three__cats"><a href="blog-list-left.html">Development</a></div><!-- /.blog-cats -->
                                    <div class="blog-three__date">26 Mar, 2023</div><!-- /.blog-date -->
                                </div>
                                <h3 class="blog-three__title">
                                ...
                                <div class="blog-three__meta">
                                    ...
                                    <a class="blog-three__rm" href="blog-details-left.html"><span class="icon-arrow"></span></a><!-- /.read-more-btn -->
                                </div><!-- /.blog-meta -->
                            </div><!-- /.blog-content -->
                        </div><!-- /.blog-card-one -->
                    </div>
        ...
        <div class="client-carousel @@extraClassName">
            <div class="container">
                <div class="client-carousel__one eduact-owl__carousel owl-theme owl-carousel" data-owl-options='{
            "items": 5,
            "margin": 65,
            "smartSpeed": 700,
            "loop":true,
            ...
            "responsive":{
                ...
                "1200":{
                    ...
                    <div class="client-carousel__one__item">
                        <img class="client-carousel__normal" src="<?= esc($APP_URL) ?>assets/images/brand/brand-1-1.png" alt="eduact">
                        <img class="client-carousel__hover" src="<?= esc($APP_URL) ?>assets/images/brand/brand-1-1.png" alt="eduact">
                    </div><!-- /.owl-slide-item-->
                    <div class="client-carousel__one__item">
                        <img class="client-carousel__normal" src="<?= esc($APP_URL) ?>assets/images/brand/brand-1-1.png" alt="eduact">
                        <img class="client-carousel__hover" src="<?= esc($APP_URL) ?>assets/images/brand/brand-1-1.png" alt="eduact">
        ...
        <section class="cta-three" data-jarallax data-speed="0.3" data-imgPosition="50% -100%">
            <div class="cta-three__bg jarallax-img" style="background-image: url(<?= esc($APP_URL) ?>assets/images/backgrounds/cta-bg-3.jpg);"></div>
            <div class="container">
                <div class="row">
                    <div class="col-md-6 wow fadeInLeft" data-wow-delay="200ms">
                        <div class="cta-three__thumb"><img src="<?= esc($APP_URL) ?>assets/images/shapes/cta-3-1.png" alt="eduact" /></div>
                        <h3 class="cta-three__title"><span>Skills Certificate</span><br> From the <span>EduAct</span></h3>
                    </div>
                    <div class="col-md-6 wow fadeInRight" data-wow-delay="300ms">
                        <div class="cta-three__btn"><a href="contact.html" class="eduact-btn"><span class="eduact-btn__curve"></span>Get In Touch</a></div>
                    </div>
                </div>
            </div>
        </section>
