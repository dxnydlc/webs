...
<section class="page-header page-header--bg-two"  >
    <div class="page-header__bg jarallax-img" style="background-image: url(/2024/banner-10.png);" ></div><!-- /.page-header-bg -->
    <div class="page-header__overlay" style="background-color:rgba(var(--eduact-black2-rgb), 0.5)" ></div><!-- /.page-header-overlay -->
    <div class="container text-center">
        <h2 class="page-header__title" style="text-transform: none;" >Contable</h2>
        <!-- /.page-title -->
            ...
            <div class="col-xl-12 ">
                ...
                <div class="course-details__tabs tabs-box">
                    ...
                    <div class="course-details__overview">
                        ...
                        brindamos la capacitación en materia contable a la medida de la 
                        necesidad de cada organización.
                        <br/><br/>
                        Los temas más requeridos por nuestros clientes son:
                        </p>

                        <ul class="list-unstyled course-details__overview__lists">
                            <li>
                                <span class="icon-check"></span>
                                Planeamiento contable empresarial.
                            </li>
                            <li>
                                <span class="icon-check"></span>
                                Planeamiento financiero empresarial.
                            </li>
                        </ul>
                    </div>
                </div><!-- tabs -->
