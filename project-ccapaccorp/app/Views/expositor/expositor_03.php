                ...
                <div class="row">
                    ...
                    <div class="col-lg-7 wow fadeInUp animated" data-wow-delay="400ms">
                        <div class="team-details__content">
                            ...
                            <br/>
                            Ha sido gestor de servicios en la Central de Consultas de SUNAT.
                            <br/>
                            Actualmente se desenvuelve como asesora legal en temas tributarios para empresas privadas y públicas.
                            </p>
                            <!-- /.team-text -->
                            <!-- /.team-text -->
                            <!-- /.skills-item -->
